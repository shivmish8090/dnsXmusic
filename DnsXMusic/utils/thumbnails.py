#  Copyright (c) 2025 Shivsingh
#  Licensed under the GNU AGPL v3.0: https://www.gnu.org/licenses/agpl-3.0.html
#  Part of the DnsXMusicBot project. All rights reserved where applicable.
...
def add_controls(img: Image.Image) -> Image.Image:
    ...
    region = img.crop(box)
    controls = Image.open("DnsXMusic/core/thumb/controls.png").convert("RGBA")
